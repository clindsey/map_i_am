(function() {
  var CountryMapScene, Region, WorldMapScene, latlng_to_xy;
  ...
  window.MapScene = (function() {
    function _Class(label_dom, label, stage_bounds, stage, map_data, scale, x_offset, y_offset, x_centering, y_centering, stage_half_width, stage_half_height, callback) {
      ...
      for (_i = 0, _len = map_data.length; _i < _len; _i++) {
        country = map_data[_i];
        this.countries.push(new Country(stage, country, scale, x_offset, y_offset, x_centering, y_centering, stage_half_width, stage_half_height, callback));
      }
      stage.update();
    }
    return _Class;
  ...
  WorldMapScene = (function() {
    ...
    function _Class(label_dom, stage_bounds, stage, map_data, stage_half_width, stage_half_height) {
      _Class.__super__.constructor.call(this, label_dom, 'World', stage_bounds, stage, map_data, 1, 0, 0, stage_half_width, stage_half_height, stage_half_width, stage_half_height, __bind(function(country) {
        if (country == null) {
          return;
        }
  ...
  CountryMapScene = (function() {
    ...
    function _Class(label_dom, stage_bounds, stage, country_data, stage_half_width, stage_half_height, callback) {
      ...
      _Class.__super__.constructor.call(this, label_dom, country_data.name, stage_bounds, stage, [country_data], p.scale, p.offset.x, p.offset.y, p.centering_x, p.centering_y, stage_half_width, stage_half_height, callback);
    }
  ...
  window.Country = (function() {
    function _Class(stage, country_data, scale, x_offset, y_offset, x_centering, y_centering, stage_half_width, stage_half_height, callback) {
