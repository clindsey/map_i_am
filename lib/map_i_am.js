(function() {
  var ContinentMapScene, CountryMapScene, EuropeanMapScene, MapMarker, Region, USMapScene, WorldMapScene, latlng_to_xy;
  ...
  window.MapIAm = (function() {
    function _Class(bind_canvas_elem_id, bind_label_elem_id, all_countries_map_data, european_countries_map_data, us_states_map_data, markers) {
      ...
      if (european_countries_map_data == null) {
        throw 'Err: european countries map data not specified!';
      }
      if (us_states_map_data == null) {
        throw 'Err: US states map data not specified!';
      }
      ...
      this.active_scene = new WorldMapScene(label_dom, this.stage_bounds, this.stage, all_countries_map_data, european_countries_map_data, us_states_map_data, this.stage_half_width, this.stage_half_height, markers);
    }
    return _Class;
  })();
  window.MapScene = (function() {
    function _Class(label_dom, label, stage_bounds, stage, map_data, scale, x_offset, y_offset, x_centering, y_centering, stage_half_width, stage_half_height, has_hover, markers, callback) {
      var background, background_options, country, marker, name, _i, _len, _ref;
      ...
      for (name in _ref) {
        marker = _ref[name];
        this.plot_marker(stage, marker, scale, x_offset, y_offset, x_centering, y_centering, stage_half_width, stage_half_height);
      }
      stage.update();
    }
    _Class.prototype.plot_marker = function(stage, marker, scale, x_offset, y_offset, x_centering, y_centering, stage_half_width, stage_half_height) {
      var px, py, xy;
      xy = latlng_to_xy({
        lat: marker.lat,
        lng: marker.lng
      ...
      px += x_centering;
      py += y_centering;
      return stage.addChild(new MapMarker(px, py));
    };
  ...
  WorldMapScene = (function() {
    ...
    function _Class(label_dom, stage_bounds, stage, all_countries_map_data, european_countries_map_data, us_states_map_data, stage_half_width, stage_half_height, markers) {
      _Class.__super__.constructor.call(this, label_dom, 'World', stage_bounds, stage, all_countries_map_data, 1, 0, 0, stage_half_width, stage_half_height, stage_half_width, stage_half_height, true, markers, __bind(function(country) {
        var top_level_zoom_callback;
        if (country == null) {
          return;
        }
        top_level_zoom_callback = __bind(function() {
          return new WorldMapScene(label_dom, stage_bounds, stage, all_countries_map_data, european_countries_map_data, us_states_map_data, stage_half_width, stage_half_height, markers);
        }, this);
        if (country.name === 'Europe') {
          return new EuropeanMapScene(label_dom, stage_bounds, stage, [country, european_countries_map_data], stage_half_width, stage_half_height, markers, top_level_zoom_callback);
        } else if (country.name === 'United States') {
          return new USMapScene(label_dom, stage_bounds, stage, [country, us_states_map_data], stage_half_width, stage_half_height, markers, top_level_zoom_callback);
        } else {
          return new CountryMapScene(label_dom, stage_bounds, stage, country, stage_half_width, stage_half_height, markers, top_level_zoom_callback);
        }
      }, this));
    }
    return _Class;
  ...
  ContinentMapScene = (function() {
    __extends(_Class, MapScene);
    function _Class(label_dom, stage_bounds, stage, country_data_arr, stage_half_width, stage_half_height, callback_class, markers, callback) {
      ...
      _Class.__super__.constructor.call(this, label_dom, continent_country.name, stage_bounds, stage, country_data, p.scale, p.offset.x, p.offset.y, p.centering_x, p.centering_y, stage_half_width, stage_half_height, true, markers, __bind(function(country) {
        ...
        return new CountryMapScene(label_dom, stage_bounds, stage, country, stage_half_width, stage_half_height, markers, __bind(function() {
          return new this.callback_class(label_dom, stage_bounds, stage, country_data_arr, stage_half_width, stage_half_height, markers, callback);
        }, this));
      }, this));
    }
    return _Class;
  ...
  EuropeanMapScene = (function() {
    ...
    function _Class(label_dom, stage_bounds, stage, country_data_arr, stage_half_width, stage_half_height, markers, callback) {
      _Class.__super__.constructor.call(this, label_dom, stage_bounds, stage, country_data_arr, stage_half_width, stage_half_height, EuropeanMapScene, markers, callback);
    }
    return _Class;
  })();
  USMapScene = (function() {
    __extends(_Class, ContinentMapScene);
    function _Class(label_dom, stage_bounds, stage, country_data_arr, stage_half_width, stage_half_height, markers, callback) {
      _Class.__super__.constructor.call(this, label_dom, stage_bounds, stage, country_data_arr, stage_half_width, stage_half_height, USMapScene, markers, callback);
    }
    return _Class;
  })();
  CountryMapScene = (function() {
    __extends(_Class, MapScene);
    function _Class(label_dom, stage_bounds, stage, country_data, stage_half_width, stage_half_height, markers, callback) {
      var p;
      p = this.determine_positioning(country_data, stage_bounds, stage_half_width, stage_half_height);
      _Class.__super__.constructor.call(this, label_dom, country_data.name, stage_bounds, stage, [country_data], p.scale, p.offset.x, p.offset.y, p.centering_x, p.centering_y, stage_half_width, stage_half_height, false, markers, callback);
    }
    return _Class;
  })();
  ...
  Region = (function() {
    ...
    _Class.prototype.show_normal_state = function() {
      return this.render_region('#FFF', '#CCC', 1);
    };
    _Class.prototype.show_hover_state = function() {
      return this.render_region('#FBB', '#999', 1);
    };
  ...
  MapMarker = (function() {
    ...
    function _Class(x, y) {
      ...
      this.graphics.beginStroke('#800');
      this.graphics.beginFill('#C99');
