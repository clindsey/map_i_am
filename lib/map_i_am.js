(function() {
  ...
  window.MapIAm = (function() {
    function _Class(bind_canvas_elem_id, bind_label_elem_id, all_countries_map_data, european_countries_map_data, us_states_map_data) {
      ...
      new WorldMapScene(label_dom, this.stage_bounds, this.stage, all_countries_map_data, european_countries_map_data, us_states_map_data, this.stage_half_width, this.stage_half_height);
    }
    return _Class;
  })();
  ...
  WorldMapScene = (function() {
    ...
    function _Class(label_dom, stage_bounds, stage, all_countries_map_data, european_countries_map_data, us_states_map_data, stage_half_width, stage_half_height) {
      _Class.__super__.constructor.call(this, label_dom, 'World', stage_bounds, stage, all_countries_map_data, 1, 0, 0, stage_half_width, stage_half_height, stage_half_width, stage_half_height, true, __bind(function(country) {
        var top_level_zoom_callback;
        if (country == null) {
          return;
        }
        top_level_zoom_callback = __bind(function() {
          return new WorldMapScene(label_dom, stage_bounds, stage, all_countries_map_data, european_countries_map_data, us_states_map_data, stage_half_width, stage_half_height);
        }, this);
        if (country.name === 'Europe') {
          return new EuropeanMapScene(label_dom, stage_bounds, stage, [country, european_countries_map_data], stage_half_width, stage_half_height, top_level_zoom_callback);
        } else if (country.name === 'United States') {
          return new USMapScene(label_dom, stage_bounds, stage, [country, us_states_map_data], stage_half_width, stage_half_height, top_level_zoom_callback);
        } else {
          return new CountryMapScene(label_dom, stage_bounds, stage, country, stage_half_width, stage_half_height, top_level_zoom_callback);
        }
      }, this));
    }
    return _Class;
