(function() {
  var CountryMapScene, EuropeanMapScene, Region, USMapScene, WorldMapScene, latlng_to_xy;
    ...
    function _Class(label_dom, stage_bounds, stage, map_data, stage_half_width, stage_half_height) {
      _Class.__super__.constructor.call(this, label_dom, 'World', stage_bounds, stage, map_data, 1, 0, 0, stage_half_width, stage_half_height, stage_half_width, stage_half_height, true, __bind(function(country) {
        ...
        if (country.name === 'Europe') {
          return new EuropeanMapScene(label_dom, stage_bounds, stage, [country, european_countries], stage_half_width, stage_half_height, __bind(function() {
            return new WorldMapScene(label_dom, stage_bounds, stage, map_data, stage_half_width, stage_half_height);
          }, this));
        } else if (country.name === 'United States') {
          return new USMapScene(label_dom, stage_bounds, stage, [country, states], stage_half_width, stage_half_height, __bind(function() {
            return new WorldMapScene(label_dom, stage_bounds, stage, map_data, stage_half_width, stage_half_height);
          }, this));
        } else {
  ...
  EuropeanMapScene = (function() {
    ...
    function _Class(label_dom, stage_bounds, stage, country_data_arr, stage_half_width, stage_half_height, callback) {
      var country_data, europe_country, p;
      europe_country = country_data_arr[0];
      country_data = country_data_arr[1];
      p = this.determine_positioning(europe_country, stage_bounds, stage_half_width, stage_half_height);
      _Class.__super__.constructor.call(this, label_dom, 'Europe', stage_bounds, stage, country_data, p.scale, p.offset.x, p.offset.y, p.centering_x, p.centering_y, stage_half_width, stage_half_height, true, __bind(function(country) {
        ...
        return new CountryMapScene(label_dom, stage_bounds, stage, country, stage_half_width, stage_half_height, __bind(function() {
          return new EuropeanMapScene(label_dom, stage_bounds, stage, country_data_arr, stage_half_width, stage_half_height, callback);
        }, this));
      }, this));
    }
    return _Class;
  ...
  USMapScene = (function() {
    __extends(_Class, MapScene);
    function _Class(label_dom, stage_bounds, stage, country_data_arr, stage_half_width, stage_half_height, callback) {
      var country_data, p, us_country;
      us_country = country_data_arr[0];
      country_data = country_data_arr[1];
      p = this.determine_positioning(us_country, stage_bounds, stage_half_width, stage_half_height);
      _Class.__super__.constructor.call(this, label_dom, 'United States', stage_bounds, stage, country_data, p.scale, p.offset.x, p.offset.y, p.centering_x, p.centering_y, stage_half_width, stage_half_height, true, __bind(function(country) {
        if (!((country != null) && (callback != null))) {
          callback();
        }
        if (country == null) {
        ...
        return new CountryMapScene(label_dom, stage_bounds, stage, country, stage_half_width, stage_half_height, __bind(function() {
          return new USMapScene(label_dom, stage_bounds, stage, country_data_arr, stage_half_width, stage_half_height, callback);
        }, this));
      }, this));
    }
    return _Class;
