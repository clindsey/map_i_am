(function() {
  ...
  MapIAm = (function() {
    ...
    MapIAm.prototype.COUNTRY_HOVER_COLOR = Graphics.getRGB(136, 0, 0, 0.3);
    ...
    MapIAm.prototype.hover_region = null;
    ...
    MapIAm.prototype.europe_map_scene = function() {
      var country, marker, name, p, _i, _len, _ref;
    ...
    MapIAm.prototype.country_map_scene = function(country, callback) {
      ...
      for (name in _ref) {
        marker = _ref[name];
        if (marker.country_code === 'US' && !(country.code != null)) {
          _ref2 = this.US_STATE_LOOKUP;
          for (state in _ref2) {
            state_abbr = _ref2[state];
            if (marker.region === state_abbr && country.name === state) {
              this.plot_marker(marker, p.scale, p.offset.x, p.offset.y, p.centering_x, p.centering_y);
            }
          }
      ...
      for (_i = 0, _len = countries.length; _i < _len; _i++) {
        ...
        _results.push(this.build_country(country, scale, x_offset, y_offset, x_centering, y_centering, __bind(function(region_shape) {
          return (__bind(function(country, country_index, callback) {
            region_shape.onClick = __bind(function() {
              this.stage.removeAllChildren();
              if (callback != null) {
                return callback(country);
              }
            }, this);
            region_shape.onMouseOver = __bind(function() {
              var region, _j, _len2, _ref;
              if (this.hover_region != null) {
                _ref = this.hover_region;
                for (_j = 0, _len2 = _ref.length; _j < _len2; _j++) {
                  region = _ref[_j];
                  this.stage.removeChild(region);
                }
              }
              this.hover_region = this.build_country(country, scale, x_offset, y_offset, x_centering, y_centering, (__bind(function(region_shape) {
                return this.hover_region = region_shape;
              }, this)), true);
              return this.stage.update();
            }, this);
            return region_shape.onMouseOut = __bind(function() {
              var region, _j, _len2, _ref;
              if (this.hover_region != null) {
                _ref = this.hover_region;
                for (_j = 0, _len2 = _ref.length; _j < _len2; _j++) {
    ...
    MapIAm.prototype.build_country = function(country, scale, offset_x, offset_y, centering_x, centering_y, callback, is_hover) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        region.beginFill(is_hover != null ? this.COUNTRY_HOVER_COLOR : this.COUNTRY_COLOR);
